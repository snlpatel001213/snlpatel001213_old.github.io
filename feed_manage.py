...
for each_entry_no in range(len(d.entries)):
    try:
        ...
        FEED_POST_TRMPLATE = '<div class="chapter"><a href="'+feed_link+'"><img src="'+feed_image+'" alt="'+feed_title+'"></a><div class="chapter_inner"><p class="chapter_number"'+feed_published+'</p><a href="'+feed_link+'"><h3 class="chapter_title">'+feed_title+'</h3></a></div></div>'
