...
A lot has been changes in object recognition and  object localisation space since last 4-5 years. Thanks following papers and one man ["Ross B. Girshick"](http://www.rossgirshick.info/), who made great contribution in this field.
...
3) calculate distance between all adjacent vertex in directed manner. For that, start form upper left corner of the image
...
This all distances will create a weighted uni-directed graph.Note that graph so created is a connected graph, i.e. there exists a path between any pair of
