...
---
“Money matters to all, the most”. I am working in Market intelligence since 1.5 years and today I am going to share some of the techniques for market research. Any market research task is a perfect example of big data processing. Hence market research can be characterized by five "V"s namely volume. veracity, velocity, variety, and Volatility.
...
let's say one wants to keep watch on the activity and public profile of particular company or entity. Well, structeured Public data about that companies growth can be obtained from Exchanges such as Nasdaq or BSE or NSE etc. Unstructured data for such entity/ company can be obtained from various sources such as news/ tweets. Unstructured data requires the great amount of preprocessing and to synchronize between an incoming stream of structured as well as unstructured data is the greater task to do. Usually, it happens that in system structured data is presently ready to apply analytics form but without bringing unstructured data to the same stage, decision cannot be made
...
An entity may be :
    ...
    3. A medicinal agent discovered for particular disease
    4. Spread of disease and related medicinal sale
    5. Supply chain management
    6. release of a new product in market
...
Named entity recognition is a bigger task, and cannot be accomplished by string matching and regex because of following reasons:
    ...
    2.3. Although fuzzy searching with a threshold by applying distance measure algorithm is little bit practical idea but do not provide required control.
...
Bidirectional LSTM applies such logic in both the direction of word; forward and backward direction so most robust results can be obtained.
    ...
    __3. CRF__ consideres word level as well as inter-word level feature in consideration.
...
For w1 w2 and w3, it will generate the following feature:
    ...
    1. is capital – [Share name are written in capital in genera;l e.g. GOOG, MSFT]
    2. is small
    3. is title case [title case have greater probability of being an entity]
    4. is alphanumeric
    5. is number
...
A) I want to find out, what are other comapanies related to J P Morgan. It returned me following list with probabilities.
...
B) I want to find out what are other companies related to Microsoft and Google. It returned me following list with probabilities.
